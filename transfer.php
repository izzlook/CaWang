...
<body>
    <div class="header">
        ...
        <h3 class="text-secondary font-weight-bold float-left logo">Ca</h3>
        <h3 class="text-secondary float-left logo2">Wang</h3>
        <a href="logout">
            <div class="logout">
                ...
                <?php 
                    ...
                    if (isset($_POST['transfer'])) {
                        if(transfer($_POST) > 0) {
                            ...
                            // // More headers
                            // $headers .= 'From: CaWang <noreply@cawang.com>'."\r\n" . 'Reply-To : '.$name.' <'.$emailPenerima.'>'."\r\n";
